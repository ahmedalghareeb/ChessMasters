...
public class FinalGame_Chess extends Applet implements ActionListener
{
	...
	JLabel pic = new JLabel (createImageIcon("intro pic chess game.jfif"));
	JButton next = new JButton ("Next");
	JButton instructionsBtn = new JButton ("Instructions");
	instructionsBtn.setActionCommand("InstructionScreen");
	...
	card1.add (pic) ;
	card1.add (next);
	card1.add (BorderLayout.CENTER, pic);
	card1.add (BorderLayout.PAGE_END, next); 
	card1.add (BorderLayout.LINE_END, instructionsBtn);
	card1.add (BorderLayout.PAGE_START, title);
	p_card.add ("1", card1);
    }
	...
	// turn
	turnpic= new JLabel (createImageIcon("GrtffindorLogo.png"));
	JButton next = new JButton ("Next");
    ...
    { //moves between the screens
		if (e.getActionCommand ().equals ("s1"))
			...
			System.exit (0);
		else if (e.getActionCommand().equals("InstructionScreen"))
			cdLayout.show (p_card, "2");
		else
		{ //code to handle the game
			...
			{
			     turn='w';
			    turnpic.setIcon(createImageIcon("GrtffindorLogo.png"));
			}
		}
    }
